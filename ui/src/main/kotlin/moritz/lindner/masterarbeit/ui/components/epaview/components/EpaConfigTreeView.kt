...
private fun buildEpaTree(rootConfig: EpaViewConfig?) = buildTree {
    rootConfig?.let { root ->
        addNode(root) {
            buildEpaTreeRecursive(root)
        }
    }
}

private fun TreeBuilder<EpaViewConfig>.buildEpaTreeRecursive(config: EpaViewConfig) {
