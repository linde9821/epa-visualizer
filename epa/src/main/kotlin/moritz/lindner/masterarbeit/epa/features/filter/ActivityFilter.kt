...
/**
 * A filter that removes all states, transitions, and events from an
 * [ExtendedPrefixAutomaton] that are not associated with the specified set
 * of allowed [Activity]s.
 *
 ...
 *
 * Orphaned states (those whose path includes disallowed activities) are
 * pruned.
 *
 * @param T The timestamp type used in the automaton's events.
 * @property allowedActivities The set of activity labels to retain in the
 *    filtered automaton.
 */
class ActivityFilter<T : Comparable<T>>(
     ...
     * @return A new [ExtendedPrefixAutomaton] that includes only allowed
     *    activities and valid state chains.
     */
    override fun apply(
