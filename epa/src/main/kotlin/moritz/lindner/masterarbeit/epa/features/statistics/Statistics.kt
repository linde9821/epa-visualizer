...
/**
 * Represents summary statistics for an
 * [moritz.lindner.masterarbeit.epa.ExtendedPrefixAutomaton]
 * or an event log.
 *
 * Captures global and activity-level metrics such as the number of events,
 * cases, activities, states, and partitions, as well as the frequency of
 * each activity.
 *
 ...
 * @property activityFrequency A mapping of each [Activity] to its observed
 *    frequency.
 */
